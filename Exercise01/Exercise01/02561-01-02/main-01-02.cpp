...
void display() {	
	...
	mat4 modelViewRect = Translate(6.0f, 7.0f, 0.0f)*RotateZ(45.0);
	mat4 modelViewTria = Translate(6.0f, 7.0f, 0.0f);
	...
	// render triangle
	glUniformMatrix4fv(modelViewUniform, 1, GL_TRUE, modelViewTria);
...
void loadGeometry() {
	...
	/*Vertex triangleData[triangleSize] = {
        { vec2(2.0, 2.0 ), colorTria },
        { vec2(5.0,  2.0 ), colorTria },
