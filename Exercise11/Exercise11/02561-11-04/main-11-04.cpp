...
void init_surface()
{
   ...
   //for (u = 0; u < numberOfControlPointsU; u++){
	  // for (v = 0; v < numberOfControlPointsV;v++){
		 ...
		 //  controlPointsSurface[u][v].y = controlPoints[u].y;
		 //  controlPointsSurface[u][v].z = (v-0.5f)*5;
	  // }
   //}
   int u, v;
   ...
   for (u = 0; u < numberOfControlPointsU; u++){
	   for (v = 0; v < numberOfControlPointsV;v++){
		   controlPointsSurface[u][v].x = controlPoints[u].x;
		   controlPointsSurface[u][v].y = controlPoints[u].y;
		   controlPointsSurface[u][v].z = (v-0.5f)*3;
	   }
   }

   
	controlPointsSurface[1][1].y = 9;
	controlPointsSurface[2][2].y = 9;
	controlPointsSurface[1][2].y = 9;
	controlPointsSurface[2][1].y = 9;

	
	controlPointsSurface[5][5].y = -3;
	controlPointsSurface[4][4].y = -3;
	controlPointsSurface[4][5].y = -3;
	controlPointsSurface[5][4].y = -3;
}    
